            ...
            // 获取商品数量
                ...
                if (count<0){
                    ...
                    return location.href =
                        "http://localhost:8080/book/cartServlet?action=updateCount&count=" + ${entry.value.count} + "&id=" + id;
                }else {
...
<div id="main">
    ...
    <c:if test="${not empty sessionScope.cart.items}">
        ...
        <div class="cart_info">
            ...
            <span class="cart_span"><a id="clearCard" href="cartServlet?action=clear">清空购物车</a></span>
